...
if len(options.inputFiles)==0:
  if Is2016:
    if isMC:
      ...
      files = cmd.getoutput('ls /data8/Users/jihkim/GeneratorTools/external/CMSSW_10_2_18/src/SKFlatMaker/SKFlatMaker/test/'+name+'/2016/MiniAOD*.root').split('\n')
      for f in files:
    ...
    if isMC:
      ...
      files = cmd.getoutput('ls /data8/Users/jihkim/GeneratorTools/external/CMSSW_10_2_18/src/SKFlatMaker/SKFlatMaker/test/'+name+'/2017/MiniAOD*.root').split('\n')
      for f in files:
        options.inputFiles.append('file:'+f)
    ...
    if isMC:
      ...
      files = cmd.getoutput('ls /data8/Users/jihkim/GeneratorTools/external/CMSSW_10_2_18/src/SKFlatMaker/SKFlatMaker/test/'+name+'/2018/MiniAOD*.root').split('\n')
      for f in files:
        options.inputFiles.append('file:'+f)
